    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center space-x-8 font-medium text-gray-800 h-full">
          ...
          >
            <Button className="bg-[#db071d] text-white hover:bg-[#8b0010] rounded-xl px-6 py-2 transition text-sm md:text-base flex items-center gap-1">
      ...
      <div className="py-6 px-6 bg-gray-50 rounded-t-xl mt-auto">
        <span className="block text-gray-900 font-semibold mb-3 flex items-center gap-2">
          <svg
            ...
            stroke="currentColor"
          >
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12h.01M12 15h.01M9 12h.01M12 3C7.582 3 4 6.582 4 11c0 4.418 3.582 8 8 8 4.418 0 8-3.582 8-8 0-4.418-3.582-8-8-8z" />
          </svg>
          Log In
        </span>
          ...
          <SheetClose asChild>
            ...
            >
              <svg
                ...
                stroke="currentColor"
              >
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c0 1.105-.895 2-2 2s-2-.895-2-2 .895-2 2-2 2 .895 2 2zM21 21H3v-2a4 4 0 014-4h10a4 4 0 014 4v2z" />
              </svg>
              Owner Portal
            </Link>
          </SheetClose>
